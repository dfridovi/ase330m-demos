 ...
 * one — this is called every animation frame from the pendulum canvas, and `.map()` there
 * would allocate a fresh array 60+ times a second, adding avoidable GC pressure to the hot path.
 */
